...
| --- | --- | --- | --- |
| Packaged files | `/usr/bin`, `/usr/lib/systemd/system`, `/usr/lib/sysusers.d`, `/usr/share/bash-completion`, `/usr/share/zsh`, `/usr/share/fish`, `/usr/share/man`, `/usr/share/doc/tunwarden` | Debian package manager | Installed, upgraded, and removed by `dpkg`/`apt`. |
...
- binary, shell completion, and man page presence.
